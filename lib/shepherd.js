...
function ZShepherd(path, opts) {
    ...
    this.on('ind:reported', function (deviceAddr, ep, cId, attrs) {
        ...
        self.emit('ind', { type: 'attReport', deviceAddr: deviceAddr, endpoints: [ ep ], data: notifData });
    });
...
ZShepherd.prototype.mount = function (zApp, callback) {
    ...
    Q.fcall(function () {
        ...
        if (coord) {
            ...
            zApp._simpleDesc.epId = mountId > 7 ? mountId + 1 : 8;  // epId 1-10 are reserved for delegator
